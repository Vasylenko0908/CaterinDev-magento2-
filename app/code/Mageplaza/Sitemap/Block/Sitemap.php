...
class Sitemap extends Template
{
    ...
    {
        return $this->_categoryHelper->getStoreCategories(true, true);
    }
    ...
    public function renderSection($section, $config, $title, $collection)
    {
        ...
        if ($config) {
            $html .= '<div class="row">';
            $html .= '<h2>' . $title . '</h2>';
            $html .= '<div class="pager"><p class="amount"><strong>14 Item(s)</strong></p></div>';
            $html .= '<div id="sitemap_top_links"><ul class="links"><li class="first last"><a href="'.$this->getUrl("sitemap/product").'" title="Products Sitemap">Products Sitemap</a></li></ul></div>';
